  ...
  "rounded-2xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "glass-card",
        elevated: "bg-card shadow-medium hover:shadow-lg",
        interactive: "bg-card border border-border shadow-soft hover:shadow-medium hover:-translate-y-1 cursor-pointer",
